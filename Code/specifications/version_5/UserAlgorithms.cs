...
namespace Version_5
{
    public static class UserAlgorithms
    {
        ...
        private static void SetColor(string objName, Color color)
        {
        ...
        public static void SetupUI()
        {
            ...
            // Apply Colors
            SetColor("tall_grass", Color.green);
            SetColor("player", Color.red);
            SetColor("pokeball", Color.red);
            
            Color purple = new Color(0.5f, 0f, 0.5f);
            SetColor("monster_A", purple);
            SetColor("monster_B", purple);
            SetColor("monster_C", purple);
        ...
        public static void ThrowPokeball()
        {
            ...
            if (pokeball != null && player != null)
            {
                ...
                StateAccessor.SetState("pokeball", "thrown", pokeball, "Version_5");
            }
        }
        ...
        private static void ResetPokeball(GameObject pokeball)
        {
            if (pokeball != null)
            {
                ...
                StateAccessor.SetState("pokeball", "ready", pokeball, "Version_5");
            }
        }
    }
}